...
def resolve_callable(callable_or_name: type | Callable | str) -> Callable:
    ...
    # Simple name - look for it in the runtime package directory. This avoids
    # scanning the outer project folder where packaging helpers like setup.py live.
    package_root = Path(__file__).resolve().parents[1]
    for _, module_name, _ in pkgutil.iter_modules([str(package_root)], "rsl_rl."):
