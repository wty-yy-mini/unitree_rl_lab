...
```bash
python scripts/rsl_rl/train.py --headless --task Unitree-G1-29dof-Mimic-Custom \
  --motion_files data/dailylife_data_v1.1/load/lift/load_lift_1_2.npz data/dailylife_data_v1.1/locomotion/jump/locomotion_jump_1_3.npz \
...
Download custom dailylife dataset generated by Kimodo from

```bash
cd unitree_rl_lab
hf download wty-yy/beyondmimic_dailylife_dataset --repo-type dataset --local-dir data
```
